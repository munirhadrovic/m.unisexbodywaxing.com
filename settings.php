<?php
	$adresa="412 Bayfront Place, Suite 104 Naples, Fl 34102."; //jako je vazno navesti dobro adresu radi boljeg poziciniranja
	$grad="";//jako je vazno ako adresa ima dva imena povezati ih sa plus
	$skracenica=""; // AKo ne znate skracenicu ostavite praznu
	$telephone=2394039669   ;// Broj koji se poziva na dugme CALL US
